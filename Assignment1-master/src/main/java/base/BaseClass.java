	...
	public static void initialize() throws IOException {
		...
		if (oProp.getProperty("browser").equalsIgnoreCase("chrome")) {
			...
			System.setProperty("webdriver.chrome.driver",
					oProp.getProperty("sourceFolderLoc") + "\\main\\java\\drivers\\chromedriver.exe");
			...
			System.setProperty("webdriver.ie.driver",
					oProp.getProperty("sourceFolderLoc") + "\\main\\java\\drivers\\ieexplorer.exe");
			...
			System.setProperty("webdriver.ie.driver",
					oProp.getProperty("sourceFolderLoc") + "\\main\\java\\drivers\\geckodriver.exe");
